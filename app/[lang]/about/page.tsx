  ...
  return (
    <div className="max-w-screen-2xl mx-auto">
      <Content
        ...
        item1="lg:basis-[40%]"
        item2="lg:basis-[50%] customer-img-1 h-[40vh] sm:h-[50vh] lg:h-[60vh]"
      />
      ...
      <Content
        ...
        item1="lg:basis-[40%]"
        item2="lg:basis-[50%] customer-img-2 h-[40vh] sm:h-[50vh] lg:h-[60vh]"
      />
      ...
      <Content
        ...
        item2="lg:w-2/3 h-[40vh] sm:h-[50vh] lg:h-[60vh]"
      />
    </div>
  );
}
